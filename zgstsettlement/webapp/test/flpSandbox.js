		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "GST Settlement",
									"targetURL": "#fischerzgstsettlement-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"fischerzgstsettlement-display": {
								"semanticObject": "fischerzgstsettlement",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=fischer.zgstsettlement",
									"url": sap.ui.require.toUrl("fischer/zgstsettlement")
								}
							}
						}
					}
