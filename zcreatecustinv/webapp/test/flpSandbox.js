		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "zfb60 t-code",
									"targetURL": "#fischerzcreatecustinv-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"fischerzcreatecustinv-display": {
								"semanticObject": "fischerzcreatecustinv",
								"action": "display",
								"description": "A Fiori application for zfb60 t-code.",
								"title": "zfb60 t-code",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=fischer.zcreatecustinv",
									"url": sap.ui.require.toUrl("fischer/zcreatecustinv")
								}
							}
						}
					}
